...
# How OpenStudios Works

**OpenStudios Lawrence** connects landlords in Lawrence, Kansas with vacant storefronts with practicing local artists who need studio space. The program is built on mutual benefit and shared community goals.
...
Landlords offer rent-free use of their vacant storefront for a set period (typically 3-4 months). OpenStudios Lawrence and the artist take care of the rest.

**Benefits to Landlords:**

- Liability insurance provided by OpenStudios Lawrence
- Utility expenses, if required, covered by OpenStudios Lawrence
...
- Support from OpenStudios Lawrence and the community
...
- Promote OpenStudios Lawrence and the space via social media (with credit)
- Understand the arrangement is temporary: if the space is rented, you will have typically 30 days to vacate.

---

### OpenStudios Lawrence Provides Infrastructure
...
OpenStudios Lawrence functions as matchmaker, administrator, and community connector.

**OpenStudios Lawrence Responsibilities:**
...
- Event coordination for OpenStudio Lawrence events
...
1. **Application Period** (ongoing)
   ...
   - Landlords with available spaces contact OpenStudios Lawrence through this website
2. **Selection** (ongoing)
   ...
   - OpenStudios Lawrence confirms artist-landlord match
3. **Setup** (typically 2 weeks)
   - Artist moves into space
   - OpenStudios Lawrence organizes the studio and promotes launch
...
4. **Active Residency** (typically 3-4 months)
   ...
   - OpenStudios provides support and promotion
5. **Transition**
   - If space is rented: Artist will vacate within agreed-upon time (typically 30 days)
   - If space remains vacant: Residency may be extended as agreed upon by landlord, artist, and OpenStudios Lawrence
...
**Everything is curated.** OpenStudios Lawrence's selection committee of artists and faculty ensures quality artistic practice and community fit.

**Our model has already succeeded.** Wichita's OpenStudios has served more than 175 artists across 20 locations since 2018..

---

## The Agreement

Both landlords and artists sign straightforward agreements that outline:
- Duration and terms of the residency
- Responsibilities for space maintenance
